    ...
    <div class="w-full max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            <div
                ...
                <p class="text-[#1F2937] dark:text-white tracking-light text-4xl font-bold leading-tight">{{$totalPortfolio}}</p>
                <p class="text-green-600 dark:text-green-500 text-sm font-medium leading-normal">+2 this month</p>
            </div>
            <div
                class="flex flex-col gap-2 rounded-xl p-6 border border-[#E5E7EB] dark:border-white/10 bg-white dark:bg-white/5 shadow-sm">
                <p class="text-[#1F2937] dark:text-gray-200 text-base font-medium leading-normal">Total Clicks (30d)</p>
                <p class="text-[#1F2937] dark:text-white tracking-light text-4xl font-bold leading-tight">1,482</p>
            ...
            <div
                ...
                <p class="text-[#1F2937] dark:text-white tracking-light text-4xl font-bold leading-tight">5</p>
            ...
            <div
                ...
                <div
                    ...
                    <div class="shrink-0"><button
                            class="text-primary text-sm font-bold leading-normal hover:underline">View</button></div>
                </div>
                <div
                    class="flex items-center gap-4 p-4 min-h-[72px] justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                    <div class="flex items-center gap-4">
                    ...
                    <div class="shrink-0"><button
                            class="text-primary text-sm font-bold leading-normal hover:underline">Reply</button></div>
                </div>
                <div
                    class="flex items-center gap-4 p-4 min-h-[72px] justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                    <div class="flex items-center gap-4">
                ...
                <div
                    ...
                    <div class="shrink-0"><button
                            class="text-primary text-sm font-bold leading-normal hover:underline">Details</button></div>
                </div>
            </div>
        </div>
    </div>
