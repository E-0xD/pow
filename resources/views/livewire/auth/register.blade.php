<x-layouts.guest>
    <div class="relative flex h-auto min-h-screen w-full flex-col items-center justify-center bg-background-light group/design-root dark:bg-background-dark p-4 sm:p-6 lg:p-8"
       >
