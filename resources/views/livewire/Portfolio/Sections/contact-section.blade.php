                ...
                @else
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                        <div class="flex items-center gap-2 w-full sm:w-auto">
                            <span
                                class="material-symbols-outlined text-primary text-xl shrink-0">{!! $contact['logo'] !!}</span>
                            <span class="font-medium text-gray-800 dark:text-gray-200">{{ $contact['method'] }}</span>
                        </div>

                        <input wire:model="contacts.{{ $index }}.value"
                        ...
                        <button type="button" wire:click="saveContact({{ $index }})"
