    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form method="POST" action="{{ route('admin.coupon.update', $coupon) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="code" id="code" value="{{ old('code', $coupon->code) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
            ...
            <div class="mb-4" id="discount_value_field" style="{{ in_array(old('type', $coupon->type->value), ['plan_discount', 'global_discount']) ? '' : 'display: none;' }}">
                ...
                <input type="number" name="discount_value" id="discount_value" value="{{ old('discount_value', $coupon->discount_value) }}" min="0" max="100" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="mb-4" id="months_value_field" style="{{ in_array(old('type', $coupon->type->value), ['free_months', 'extra_months']) ? '' : 'display: none;' }}">
                ...
                <input type="number" name="months_value" id="months_value" value="{{ old('months_value', $coupon->months_value) }}" min="1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="max_uses" id="max_uses" value="{{ old('max_uses', $coupon->max_uses) }}" min="1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="expires_at" id="expires_at" value="{{ old('expires_at', $coupon->expires_at ? $coupon->expires_at->format('Y-m-d\TH:i') : '') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
