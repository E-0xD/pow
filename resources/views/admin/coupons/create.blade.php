...
<div class="mx-auto max-w-4xl px-4 py-8">
    <h1 class="text-text-light dark:text-text-dark text-3xl font-black tracking-tighter mb-6">Create Coupon</h1>
    ...
    <div class="bg-card-light dark:bg-card-dark shadow-md rounded-lg p-6 border border-border-light dark:border-border-dark">
        <form method="POST" action="{{ route('admin.coupon.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="code" id="code" value="{{ old('code') }}" class="mt-1 block w-full border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark rounded-md shadow-sm focus:ring-primary focus:border-primary" required>
            ...
            <div class="mb-4" id="months_value_field" style="display: none;">
                ...
                <input type="number" name="months_value" id="months_value" value="{{ old('months_value') }}" min="1" class="mt-1 block w-full border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark rounded-md shadow-sm focus:ring-primary focus:border-primary">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="max_uses" id="max_uses" value="{{ old('max_uses') }}" min="1" class="mt-1 block w-full border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark rounded-md shadow-sm focus:ring-primary focus:border-primary">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="expires_at" id="expires_at" value="{{ old('expires_at') }}" class="mt-1 block w-full border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark rounded-md shadow-sm focus:ring-primary focus:border-primary">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="bg-primary hover:opacity-90 text-text-dark font-bold py-2 px-4 rounded">Create Coupon</button>
            </div>
        </form>
    </div>
</div>
