<x-layouts.app>
    ...
    <div class="mx-auto max-w-2xl">
        <!-- PageHeading -->
        <div class="mb-6">
            <h1 class="text-gray-900 dark:text-white text-3xl font-bold leading-tight tracking-tight">Edit Partner</h1>
        </div>

        <div class="bg-white dark:bg-[#20152d] rounded-xl p-6">
            <form method="POST" action="{{ route('admin.partner.update', $partner) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="api_key" id="api_key" value="{{ $partner->api_key }}" readonly
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm bg-gray-100 dark:bg-gray-700" readonly>
                    <p class="mt-1 text-sm text-gray-500">API key is auto-generated and cannot be changed.</p>
                </div>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit"
                        class="px-4 py-2 text-sm font-medium text-white bg-primary border border-transparent rounded-md hover:bg-primary/90">Update Partner</button>
                </div>
            </form>
        </div>
    </div>
